...
export const seasonalStatus = createStatusController({ tag: "STCH Seasonal", logId: "stch-seasonal-log", statusId: "stch-seasonal-status", progressWrapId: "stch-seasonal-progress-wrap", progressBarId: "stch-seasonal-progress-bar", progressTextId: "stch-seasonal-progress-text" });
